...
public class AdminController {
	...
	public String goodsEnrollPOST(BookVO book, RedirectAttributes rttr) {
	    logger.info("goodsEnrollPOST - Received data: " + book);
	    
	    try {
	        adminService.bookEnroll(book);
	        logger.info("goodsEnrollPOST - Book enrolled successfully.");
	    } catch (Exception e) {
	        logger.error("goodsEnrollPOST - Error enrolling book: " + e.getMessage());
	    }
	...
	public void authorPopGET(Criteria cri, Model model) throws Exception {
		...
		/* 페이지 이동 인터페이스 데이터 */
		model.addAttribute("pageMaker", new PageVO(cri, authorService.authorGetTotal(cri)));
