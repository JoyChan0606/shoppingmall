...
<body>
	...
	<script>
		...
		$(".mail_check_input").blur(function() {
			var inputCode = $(".mail_check_input").val(); //입력 코드
		...
		function execution_daum_address(){
		    ...
		    new daum.Postcode({
		        oncomplete: function(data) {
					...
					$(".address_input_1").val(data.zonecode);  //$("[name=memberAddr1]").val(data.zonecode); 대체가능
					$(".address_input_2").val(addr);		   //$("[name=memberAddr2]").val(addr);          대체가능
		 			//상세주소 입력란 disabled 속성 변경및 커서를 상세주소 필드로 이동
